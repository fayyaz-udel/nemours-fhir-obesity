...
ARG_PARSER.add_argument('--patience', default=7, type=int)
ARG_PARSER.add_argument('--patience_disc', default=10, type=int)
...
ARG_PARSER.add_argument('--labels', default=2, type=float)
# ARG_PARSER.add_argument('--time', default=8, type=float)
ARG_PARSER.add_argument('--rnnLayers', default=2, type=float)
# ARG_PARSER.add_argument('--embedding_size', default=256, type=float)
# ARG_PARSER.add_argument('--latent_size', default=256, type=float)
# ARG_PARSER.add_argument('--rnn_size', default=512, type=float)
ARG_PARSER.add_argument('--lrn_rate', default=0.001, type=float)
ARG_PARSER.add_argument('--lrn_critic', default=0.00005, type=float)
